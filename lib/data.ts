...
export const dailyCards: DailyCard[] = [
  {
    ...
    summary:
      "A measured three-play card built around San Antonio's current form and a cleaner NHL matchup edge for Ottawa, with one NBA total included as a smaller position rather than an all-in stance.",
    premiumIntro:
      "Premium members get the full market context, injury check, unit sizing notes, and the late-day watchlist before any number moves again.",
    recordLabel: "Fresh card, lines subject to move",
    picks: [
      {
        id: "m1",
        date: "2026-03-23",
        event: "Senators vs. Rangers",
        sport: "Hockey",
        league: "NHL",
        pickTitle: "Ottawa has the cleaner full-game edge",
        betType: "Moneyline",
        market: "Moneyline",
        line: "Senators ML",
        odds: "-192",
        ...
        units: 1.5,
        shortSummary:
          "Ottawa brings the better recent form, the stronger season scoring profile, and a major edge against a Rangers team that has dropped four straight.",
        premiumTeaser: "Unlock the goaltending angle, price discipline note, and why this favorite still made the top slot.",
        premiumAnalysis:
          "This is the strongest profile on the board even with the heavier price. Ottawa enters at 36-24-9 with wins in four of its last five, while New York is 9-17-7 at home and carries a four-game skid into the night. The Senators are scoring 3.35 goals per game to the Rangers' 2.79, and the matchup still prices inside a range we can live with for a featured moneyline rather than forcing a puck-line position.",
        result: "pending",
        isBestBet: true
      },
      {
        ...
        sport: "Basketball",
        league: "NBA",
        pickTitle: "San Antonio still deserves favorite treatment",
        betType: "Spread",
        market: "Spread",
        line: "Spurs -3.5",
        odds: "-108",
        ...
        units: 1,
        shortSummary:
          "The number came down from the opener, but San Antonio still carries the stronger recent form, the better defensive baseline, and the cleaner season-long profile.",
        premiumTeaser: "Members get the line-move context, form split, and why the opener mattered more than the current sticker shock.",
        premiumAnalysis:
          "San Antonio has won five straight, sits 53-18 overall, and owns a clear points-allowed edge over Miami, 111.7 to 117.2. The market opened Spurs -5.5 and has been bet down to -3.5, which gives this a better entry point than the opener if you still trust the stronger side. Miami is capable offensively, but the Heat have lost four straight and have not defended well enough lately to make me eager to grab the points against a team with San Antonio's current form.",
        result: "pending"
      },
      {
        id: "m3",
        ...
        sport: "Basketball",
        league: "NBA",
        pickTitle: "The total is playable as a smaller-position over",
        betType: "Total",
        market: "Total",
        line: "Over 244.5",
        odds: "-105",
        ...
        units: 0.5,
        shortSummary:
          "Both teams have scoring juice, Miami's recent defensive form has slipped badly, and the market has already pushed this total up from the opener.",
        premiumTeaser: "Unlock the pace note, market move explanation, and why this stayed in the lean bucket instead of the core exposure tier.",
        premiumAnalysis:
          "This number opened around 240.5 and has already been pushed to 244.5, so we are not pretending to beat the best of it. Even so, the case still exists for a smaller-position over. Miami is scoring 120.3 points per game but allowing 117.2, San Antonio is scoring 119.0, and the Heat have allowed 123, 134, and 136 points in three of their last four losses. The move explains why this is a lean rather than a core bet, but the game environment still profiles as more offense-friendly than the current sticker suggests.",
        result: "pending"
      }
    ]
  },
